<%@ Page Language="C#" MasterPageFile="~/Supplier/SupplierMaster.master" AutoEventWireup="true" CodeFile="frmSearchBykey.aspx.cs" Inherits="Supplier_frmSearchBykey" Title="Untitled Page" %>
    ...
    <table style="width: 100%;vertical-align:central">
        ...
        <tr>
            <td>
                <table>
                    <tr>
                        <td style="padding:10px;margin-bottom:20px;">
                             Enter keyword
                        </td>
                        <td>
                <asp:TextBox ID="txtSearch" Class="form-control"  runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ControlToValidate="txtSearch" ErrorMessage="*"></asp:RequiredFieldValidator></td>
                    </tr>
                </table>
        ...
        <tr>
            <td align="center"><asp:Button ID="btnSearch" class="btn btn-Primary" runat="server" Font-Bold="True" 
