...
public partial class Supplier_frmTodaysTenders : System.Web.UI.Page
{
    ...
    public void GetData()
    {
        ...
        GridView1.DataSource = obj.GetTodaysTenders();
        GridView1.DataBind();
        if (GridView1.Rows.Count == 0)
        {
            lblMessage.Text = "today not addded any items for bidding";
        }
        else
            lblMessage.Text = "";
    ...
    {
        Label l = GridView1.Rows[e.NewSelectedIndex].FindControl("tid") as Label;
        int tenderid = Convert.ToInt32(l.Text);
        Response.Redirect("frmIssuerOrderItem.aspx?tenderid=" + tenderid);
    }
